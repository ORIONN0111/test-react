...
const DevToolUI = ({ control, placement = 'top-right', }) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        !state.visible && (React.createElement(Button, { title: "Show dev panel", hideBackground: true, style: Object.assign(Object.assign({ position: 'fixed', zIndex: 99999 }, getPositionByPlacement(placement, 3, 3)), { padding: 3, margin: 0, background: 'none' }) },
...
function useExportControlToExtension(control) {
    ...
    useDeepCompareEffect(() => {
        ...
        const nativeFields = flatFieldNames.reduce((perv, name) => {
            var _a, _b, _c;
            perv[name] = !!((_c = (_b = (_a = _.get(control._fields, name)) === null || _a === void 0 ? void 0 : _a._f) === null || _b === void 0 ? void 0 : _b.ref) === null || _c === void 0 ? void 0 : _c.type);
            return perv;
        }, {});
...
const DevTool = (props) => {
    ...
    return (React.createElement(StateMachineProvider, null,
        React.createElement(DevToolUI, { control: (_b = props === null || props === void 0 ? void 0 : props.control) !== null && _b !== void 0 ? _b : methods.control, placement: props === null || props === void 0 ? void 0 : props.placement })));
};
