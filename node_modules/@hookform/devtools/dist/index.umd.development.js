        ...
        for (const key of fieldsNames || Object.keys(fields)) {
            ...
            if (field) {
                ...
                if (_f && callback(_f.name)) {
                    if (_f.ref.focus && isUndefined$2(_f.ref.focus())) {
                        break;
                    }
                    else if (_f.refs) {
                        _f.refs[0].focus();
                ...
                if (currentPathsLength === index &&
                    ((isObject$1(objectRef) && isEmptyObject(objectRef)) ||
                        (Array.isArray(objectRef) &&
                            !objectRef.filter((data) => !isUndefined$2(data)).length))) {
    ...
    ***************************************************************************** */
    ...
    function nestToFlat(flatKeys, obj, defaultValue) {
        return flatKeys.reduce((perv, name) => {
            ...
            perv[name] = lodash.get(obj, name) || defaultValue;
            return perv;
        }, {});
    }
    ...
    function useExportControlToExtension(control) {
        ...
        useDeepCompareEffect(() => {
            ...
            const nativeFields = flatFieldNames.reduce((perv, name) => {
                var _a, _b, _c;
                perv[name] = !!((_c = (_b = (_a = lodash.get(control._fields, name)) === null || _a === void 0 ? void 0 : _a._f) === null || _b === void 0 ? void 0 : _b.ref) === null || _c === void 0 ? void 0 : _c.type);
                return perv;
            }, {});
    ...
    const DevTool = (props) => {
        var _a, _b;
        const methods = useFormContext();
        const { isExtensionEnabled } = useExportControlToExtension((_a = props === null || props === void 0 ? void 0 : props.control) !== null && _a !== void 0 ? _a : methods.control);
        if (isExtensionEnabled) {
            return null;
        }
        return (React__namespace$1.createElement(o, null,
            React__namespace$1.createElement(DevToolUI, { control: (_b = props === null || props === void 0 ? void 0 : props.control) !== null && _b !== void 0 ? _b : methods.control, placement: props === null || props === void 0 ? void 0 : props.placement })));
    };
