(function (global, factory) {
    ...
    function useFormState(props) {
        ...
        useSubscribe({
            disabled,
            callback: React__default["default"].useCallback((value) => _mounted.current &&
    ...
    function useWatch(props) {
        ...
        useSubscribe({
            ...
            callback: React__default["default"].useCallback((formState) => {
                if (shouldSubscribeByName(_name.current, formState.name, exact)) {
                    const fieldValues = generateWatchOutput(_name.current, control._names, formState.values || control._formValues);
                    updateValue(isUndefined$2(_name.current) ||
                        (isObject$1(fieldValues) && !objectHasFunction(fieldValues))
                        ? { ...fieldValues }
                        : Array.isArray(fieldValues)
                            ? [...fieldValues]
                            : isUndefined$2(fieldValues)
                                ? defaultValue
                                : fieldValues);
                }
            }, [control, exact, defaultValue]),
        });
        const [value, updateValue] = React__default["default"].useState(isUndefined$2(defaultValue)
    ...
    function unset(object, path) {
        const updatePath = isKey$1(path) ? [path] : stringToPath$1(path);
        const childObject = updatePath.length == 1 ? object : baseGet$1(object, updatePath);
    ...
    function createFormControl(props = {}) {
        ...
        const updateTouchAndDirty = (name, fieldValue, isBlurEvent, shouldDirty, shouldRender) => {
            ...
            if (_proxyFormState.dirtyFields && (!isBlurEvent || shouldDirty)) {
                const isPreviousFieldDirty = get$1(_formState.dirtyFields, name);
                ...
                isFieldDirty =
                    isFieldDirty ||
                        isPreviousFieldDirty !== get$1(_formState.dirtyFields, name);
            }
            ...
            for (const name in fields) {
                ...
                if (field) {
                    ...
                    if (_f) {
                        ...
                        const fieldError = await validateField(field, get$1(_formValues, _f.name), shouldDisplayAllAssociatedErrors, _options.shouldUseNativeValidation, isFieldArrayRoot);
        ...
        const _getFieldArray = (name) => compact(get$1(_stateFlags.mount ? _formValues : _defaultValues, name, props.shouldUnregister ? get$1(_defaultValues, name, []) : []));
        ...
        const onChange = async (event) => {
            ...
            if (field) {
                ...
                if (_options.resolver) {
                    ...
                    error = (await validateField(field, get$1(_formValues, name), shouldDisplayAllAssociatedErrors, _options.shouldUseNativeValidation))[name];
    ...
    function useForm(props = {}) {
        ...
        useSubscribe({
            subject: control._subjects.state,
            callback: React__default["default"].useCallback((value) => {
...
`;
    ...
    const DevToolUI = ({ control, placement = 'top-right', }) => {
        const { state, actions } = a({
            setVisible,
        });
        ...
        return (React__namespace$1.createElement(React__namespace$1.Fragment, null,
            ...
            !state.visible && (React__namespace$1.createElement(Button, { title: "Show dev panel", hideBackground: true, style: Object.assign(Object.assign({ position: 'fixed', zIndex: 99999 }, getPositionByPlacement(placement, 3, 3)), { padding: 3, margin: 0, background: 'none' }) },
    ...
    ***************************************************************************** */
    ...
    const DevTool = (props) => {
        ...
        return (React__namespace$1.createElement(o, null,
            React__namespace$1.createElement(DevToolUI, { control: (_c = props === null || props === void 0 ? void 0 : props.control) !== null && _c !== void 0 ? _c : methods.control, placement: props === null || props === void 0 ? void 0 : props.placement })));
    };
